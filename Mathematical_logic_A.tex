...
入力の命題変数を$A_1,\ldots,A_n$として，真理値表が与えられているとする．結果の真偽値が$\bF$となる各行$l = 1, \ldots, m$について，次のような節$C_l$を一つずつ用意する．
...
\[Y \dequal C_1\wedge\cdots\wedge C_m\]
...
\begin{enumerate}
  ...
  \item $\Delta$の場合には同様にexchange-right'で一番右に移動する．その後は$\Gamma$の場合と同様にして$T$を延長する．
  \item 1に戻る．
\end{enumerate}
\paragraph{停止性}
...
\begin{enumerate}
  ...
  \item $\forall x,y\;E\leftrightarrow\forall y,x\;E$
  \item $\exists x,y\;E\leftrightarrow\exists y,x\;E$
